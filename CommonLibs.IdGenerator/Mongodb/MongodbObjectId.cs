namespace CommonLibs.IdGenerator.Mongodb
{
    ...
    */
    ...
    [Serializable]
#endif
    internal struct MongodbObjectId : IComparable<MongodbObjectId>, IEquatable<MongodbObjectId>, IConvertible
    {
        // private static fields
        private static readonly MongodbObjectId __emptyInstance = default(MongodbObjectId);
        ...
        public MongodbObjectId(byte[] bytes)
        {
            if (bytes == null)
            {
        ...
        internal MongodbObjectId(byte[] bytes, int index)
        {
        ...
        public MongodbObjectId(DateTime timestamp, int machine, short pid, int increment)
        ...
        /// <param name="pid">The PID.</param>
        /// <param name="increment">The increment.</param>
        public MongodbObjectId(int timestamp, int machine, short pid, int increment)
        {
        ...
        public MongodbObjectId(string value)
        {
            if (value == null)
            {
        ...
        /// </summary>
        public static MongodbObjectId Empty
        {
        ...
        public static bool operator <(MongodbObjectId lhs, MongodbObjectId rhs)
        {
        ...
        public static MongodbObjectId GenerateNewId()
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static MongodbObjectId GenerateNewId(DateTime timestamp)
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static MongodbObjectId GenerateNewId(int timestamp)
        {
            int increment = Interlocked.Increment(ref __staticIncrement) & 0x00ffffff; // only use low order 3 bytes
            return new MongodbObjectId(timestamp, __staticMachine, __staticPid, increment);
        }
        ...
        public static MongodbObjectId Parse(string s)
        {
            if (s == null)
            {
        ...
        public static bool TryParse(string s, out MongodbObjectId  objectId)
        {
            ...
            if (s != null && s.Length == 24)
            {
                ...
                {
                    objectId = new MongodbObjectId(bytes);
                    return true;
                }
            }

            objectId = default(MongodbObjectId);
            return false;
        }
        ...
        public int CompareTo(MongodbObjectId other)
        {
        ...
        public bool Equals(MongodbObjectId rhs)
        {
            return
                _a == rhs._a &&
                _b == rhs._b &&
        ...
        {
            if (obj is MongodbObjectId)
            {
                return Equals((MongodbObjectId)obj);
            }
            else
            {
                return false;
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            switch (Type.GetTypeCode(conversionType))
            {
                ...
                case TypeCode.Object:
                    if (conversionType == typeof(object) || conversionType == typeof(MongodbObjectId))
                    {
                        return this;
                    }
                    break;
